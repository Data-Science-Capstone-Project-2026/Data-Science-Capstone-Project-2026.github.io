...
- **[Data](data.qmd)** — where the data came from and how it was cleaned
- **[Analysis](analysis.qmd)** — how we approached the problem
- **[Findings](findings.qmd)** — what we learned and what it means for Admissions
