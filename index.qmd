...
---
<div class="hero-banner" style="background-image: url('images/banner.jpg');"></div>
...
::: {.button-row}
[Seira's Portfolio](https://Seira-Ram.github.io){.btn .btn-outline-primary role="button"}
[Courtney's Portfolio](https://courtneysto.github.io){.btn .btn-outline-primary role="button"}
:::
